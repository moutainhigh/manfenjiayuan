 ...
 */
public class InvIoGoodsFragment extends PDAScanFragment
...
//            labelSignQuantity.setEtContent(String.format("%.2f", curGoods.getSignQuantity()));
    ...
    private void queryNetGoods(String barcode) {
        if (!NetWorkUtil.isConnect(MfhApplication.getAppContext())) {
            onChainGoodsSkuViewError(getString(R.string.toast_network_error));
            return;
        }
