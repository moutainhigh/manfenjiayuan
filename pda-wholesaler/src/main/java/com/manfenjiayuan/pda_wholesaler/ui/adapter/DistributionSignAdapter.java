 ...
 */
public class DistributionSignAdapter extends RegularAdapter<DistributionSignEntity, DistributionSignAdapter.ProductViewHolder> {
    ...
    public void onBindViewHolder(ProductViewHolder holder, int position) {
        try {
            ...
            holder.tvTotalCount.setText(MUtils.formatDouble("单据数量:", "",
                    entity.getTotalCount(), "无", "", entity.getUnitSpec()));
            holder.tvQuantity.setText(MUtils.formatDouble("签收数量:", "",
                    entity.getQuantityCheck(), "无", null, null));
