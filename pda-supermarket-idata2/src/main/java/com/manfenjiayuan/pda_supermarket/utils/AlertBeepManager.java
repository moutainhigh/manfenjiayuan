 ...
 */
public class AlertBeepManager implements MediaPlayer.OnCompletionListener,
        MediaPlayer.OnErrorListener, Closeable {
    private static final String TAG = "AlertBeepManager";
    ...
    public AlertBeepManager(Activity activity) {
