 ...
 */
public class SendAbleOrdersFragment extends BaseListFragment<ScOrder>
    ...
    public static SendAbleOrdersFragment newInstance(Bundle args) {
        SendAbleOrdersFragment fragment = new SendAbleOrdersFragment();
...
//            onLoadFinished();
        ...
        mScOrderPresenter.findSendAbleOrders(mPageInfo);
