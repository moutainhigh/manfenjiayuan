 ...
 */
public class ScOrderCancelledFragment extends BaseListFragment<ScOrder>
    ...
    public static ScOrderCancelledFragment newInstance(Bundle args) {
        ScOrderCancelledFragment fragment = new ScOrderCancelledFragment();
...
//            onLoadFinished();
        ...
        mScOrderPresenter.findCancelOrders(mPageInfo, roleType);
