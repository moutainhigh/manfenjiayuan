 ...
 */
public class PrepareAbleOrdersFragment extends BaseListFragment<ScOrder>
...
//                ZLogger.d(String.format("%s %d(%d)", (dy > 0 ? "向上滚动" : "向下滚动"), lastVisibleItem, totalItemCount));
        ...
        orderAdapter = new ScOrderAdapter(getActivity(), null, true, true);
...
//                    extras.putInt(BaseActivity.EXTRA_KEY_ANIM_TYPE, BaseActivity.ANIM_TYPE_NEW_FLOW);
                ...
                extras.putSerializable(AcceptPrepareOrdersFragment.EXTRA_KEY_SCORDER,
