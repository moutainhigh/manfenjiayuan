 ...
 */
public class ScOrderServicingFragment extends BaseListFragment<ScOrder>
    ...
    public static ScOrderServicingFragment newInstance(Bundle args) {
        ScOrderServicingFragment fragment = new ScOrderServicingFragment();
...
//            onLoadFinished();
        ...
        mScOrderPresenter.findServicingOrders(mPageInfo, roleType);
