 ...
 */
public class ScOrderServicedFragment extends BaseListFragment<ScOrder>
    ...
    public static ScOrderServicedFragment newInstance(Bundle args) {
        ScOrderServicedFragment fragment = new ScOrderServicedFragment();
    ...
    protected void createViewInner(View rootView, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (args != null) {
            ...
            roleType = args.getInt(EXTRA_KEY_ROLETYPE);
        }
        setupSwipeRefresh();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        switch (requestCode) {
            case ARCode.ARC_ACCEPT_PREPAREORDER: {
...
//                    extras.putInt(BaseActivity.EXTRA_KEY_ANIM_TYPE, BaseActivity.ANIM_TYPE_NEW_FLOW);
                ...
                extras.putSerializable(ScOrderFragment.EXTRA_KEY_SCORDER,
                        orderAdapter.getEntity(position));
                PrimaryActivity.actionStart(getActivity(), extras);
//                Intent intent = new Intent(getActivity(), PrimaryActivity.class);
//                if (extras != null){
//                    intent.putExtras(extras);
//                }
//                startActivityForResult(intent, ARCode.ARC_ACCEPT_PREPAREORDER);
            }
...
//            onLoadFinished();
        ...
        mScOrderPresenter.findServicedOrders(mPageInfo, roleType, status);
