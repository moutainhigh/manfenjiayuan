...
public class Constants {
    ...
    public static final String BROADCAST_KEY_RECEIVE_ORDER = "BROADCAST_KEY_RECEIVE_ORDER";
    public static final String BROADCAST_KEY_NOTIFY_MFPARTER_PEISONG = "BROADCAST_KEY_NOTIFY_MFPARTER_PEISONG";
    ...
    public static void initDbVersion() {
        DbVersion.setDomainVersion("PMB.CLIENT.DB.UPGRADE", 16);
    }
}
