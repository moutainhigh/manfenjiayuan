...
public class WXConstants {
    ...
    public static final String APP_ID = "wx078cc14790abe227";
    //Appsecret APPID对应的接口密码
    public static final String APP_SECRET = "16e9495a5c0e380d06f83e0475e4ca56";

    // 微信支付商户号
    public static final String MCH_ID = "1264071401";
    // API密钥，在商户平台设置
    public static final  String API_KEY= "manfenjiayuanchunchenwangluo2016";
