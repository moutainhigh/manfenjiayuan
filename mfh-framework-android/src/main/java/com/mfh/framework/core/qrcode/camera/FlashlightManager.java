...
package com.mfh.framework.core.qrcode.camera;
...
final class FlashlightManager {
  ...
  static {
    ...
    if (iHardwareService == null) {
      ZLogger.v(TAG, "This device does supports control of a flashlight");
    } else {
      ZLogger.v(TAG, "This device does not support control of a flashlight");
    }
  }
