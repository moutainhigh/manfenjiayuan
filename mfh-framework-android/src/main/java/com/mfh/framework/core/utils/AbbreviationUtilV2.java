...
public class AbbreviationUtilV2 {
    ...
    private static char[] chartable = { '啊', '芭', '擦', '搭', '蛾', '发', '噶', '哈', '击',
            '喀', '垃', '妈', '拿', '哦', '啪', '期', '然', '撒', '塌', '挖', '昔', '压', '匝', };
    ...
    private static char[] CAPITAL_INITIAL_TABLE = { 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H',  'J', 'K',
            'L', 'M', 'N', 'O', 'P', 'Q', 'R', 'S', 'T', 'W', 'X', 'Y', 'Z', };
    ...
    private static char Char2Initial(char ch) {
        ...
        int i;
        for (i = 0; i < 23; i++) {// 判断匹配码表区间，匹配到就break,判断区间形如“[,)”
        ...
        return CAPITAL_INITIAL_TABLE[i]; // 在码表区间中，返回首字母(大写)
    }
