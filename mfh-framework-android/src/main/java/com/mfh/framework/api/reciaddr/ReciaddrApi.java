...
public class ReciaddrApi {
    public static String URL_IRECIADDR = MfhApi.URL_BASE_SERVER + "/reciaddr/";
    /**
     * 查询所有收货地址
     * http://admin.mixicook.com/pmc/reciaddr/getDefaultAddrsByHuman?humanId=136060
     */
    private static String URL_GETALLADDRS_BYHUMAN = URL_IRECIADDR + "getAllAddrsByHuman";
    /**
     * 查询默认收货地址
     * http://admin.mixicook.com/pmc/reciaddr/getDefaultAddrsByHuman?humanId=136060
     */
    private static String URL_GETDEFAULTADDRS_BYHUMAN = URL_IRECIADDR + "getDefaultAddrsByHuman";

    /**
     * 创建收货地址
     * http://admin.mixicook.com/pmc/reciaddr/createForHuman?humanId=136060
     */
    private static String URL_CREATEFORHUMAN = URL_IRECIADDR + "createForHuman";

    /**
     * 编辑收货地址
     * http://admin.mixicook.com/pmc/reciaddr/createForHuman?humanId=136060
     */
    private static String URL_UPDATEFORHUMAN = URL_IRECIADDR + "updateForHuman";

    /**
     * 删除收货地址
     * http://admin.mixicook.com/pmc/reciaddr/delete?humanId=136060
     */
    private static String URL_DELETE = URL_IRECIADDR + "delete";
     ...
     */
    private static String URL_SETDEFAULTADDR_BYID = URL_IRECIADDR + "setDefaultAddrById";


    public static void register() {
        URL_IRECIADDR = MfhApi.URL_BASE_SERVER + "/reciaddr/";
        URL_GETALLADDRS_BYHUMAN = URL_IRECIADDR + "getAllAddrsByHuman";
        URL_GETDEFAULTADDRS_BYHUMAN = URL_IRECIADDR + "getDefaultAddrsByHuman";

        URL_CREATEFORHUMAN = URL_IRECIADDR + "createForHuman";
        URL_UPDATEFORHUMAN = URL_IRECIADDR + "updateForHuman";
        URL_DELETE = URL_IRECIADDR + "delete";
        URL_SETDEFAULTADDR_BYID = URL_IRECIADDR + "setDefaultAddrById";
    }
