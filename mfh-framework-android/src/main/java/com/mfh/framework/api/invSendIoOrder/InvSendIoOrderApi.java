...
public class InvSendIoOrderApi {
    public static String URL_INVSENDIOORDER = MfhApi.URL_BASE_SERVER + "/invSendIoOrder/";


    /**
     * 创建正常发货单（/invSendIoOrder/create 用于发起独立门店间调拨，其实相当于销售供货）
     */
    static String URL_INVSENDIOORDER_CREATE = URL_INVSENDIOORDER + "create";
     ...
     */
    static String URL_CREATE_BACKORDER = URL_INVSENDIOORDER + "createBackOrder";
    /**
     * 由发货方创建调拨单
     ...
     */
    static String URL_INVSENDIOORDER_CREATE_TRANSORDER = URL_INVSENDIOORDER + "createTransOrder";
     ...
     */
    public static String URL_LIST = URL_INVSENDIOORDER + "list";
    /**
     * 对指定的发货单或收货单进行审核确认操作,若当前操作人员所属网点与单据的发货网点或收货网点一致，还会自动进行出库或入库操作。/invSendIoOrder/doConfirm?id=1
     */
    static String URL_INVSENDIOORDER_DOCONFIRM = URL_INVSENDIOORDER + "doConfirm";
    /**
     ...
     */
    static String URL_INVSENDIOORDER_DORECEIVE = URL_INVSENDIOORDER + "doReceive";
