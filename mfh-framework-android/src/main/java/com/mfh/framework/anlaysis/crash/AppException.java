...
public class AppException extends Exception implements UncaughtExceptionHandler {
    ...
    public static String CRASH_FOLDER_PATH = "Crash";//可以在外面修改
    public static String CRASH_FILE_NAME= "Crash.txt";//可以在外面修改
...
//        String fileName = "crash-" + time + "-" + timestamp + ".log";
        ...
        PrintWriter pw = new PrintWriter(new BufferedWriter(new FileWriter(
                file, append)));
        // 导出发生异常的时间
        pw.println(TimeUtil.format(new Date(), "yyyy-MM-dd-HH-mm-ss"));
        // 导出手机信息
        dumpPhoneInfo(pw);
        pw.println();
        // 导出异常的调用栈信息
