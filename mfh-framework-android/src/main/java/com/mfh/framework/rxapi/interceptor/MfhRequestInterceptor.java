...
//            ZLogger.d(String.format("---> [%s] %s on %s%s", originalRequest.method(),
...
//            ZLogger.d(String.format("---> [%s] %s on %s%s", compressedRequest.method(),
//                    compressedRequest.url(), chain.connection(), compressedRequest.headers()));

//            RequestBody body = compressedRequest.body();
//            BufferedSink sink = new BufferedSink() {
//            };
//            body.writeTo(sink);
//            Buffer buffer = new Buffer();
//            body.writeTo(buffer);
//            ZLogger.df(String.format("---> body: Content-Length:%d %s", body.contentLength(),
//                    buffer.readUtf8()));
