 ...
 */
public final class MfhHttpLoggingInterceptor implements Interceptor {
...
//        Platform.get().log(INFO, message, null);
    ...
    public MfhHttpLoggingInterceptor() {
        this(Logger.DEFAULT);
    }

    public MfhHttpLoggingInterceptor(Logger logger) {
        this.logger = logger;
    }
     ...
     */
    public MfhHttpLoggingInterceptor setLevel(Level level) {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        logger.logf(requestStartMessage);
        ...
        logger.logf("<-- " + response.code() + ' ' + response.message() + ' '
        ...
        if (logHeaders) {
            ...
            if (!logBody || !HttpHeaders.hasBody(response)) {
                ...
                if (!isPlaintext(buffer)) {
                    logger.log("");
                    logger.logf("<-- END HTTP (binary " + buffer.size() + "-byte body omitted)");
                    return response;
                }
