package com.mfh.framework.uikit.gridpasswordview;
...
import com.mfh.framework.uikit.gridpasswordview.imebugfixer.ImeDelBugFixedEditText;
...
public class GridPasswordView extends LinearLayout implements PasswordView {
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        softInputEnableInTouchMode = ta.getBoolean(R.styleable.gridPasswordView_softInputEnableInTouchMode, true);
    ...
    private void inflaterViews(Context context) {
        ...
        while (index < mPasswordLength) {
            View dividerView = inflater.inflate(R.layout.grid_password_divider, null);
    ...
    public void responseKeycodeDel(){
    ...
    private OnKeyListener onKeyListener = new OnKeyListener() {
        ...
        public boolean onKey(View v, int keyCode, KeyEvent event) {
            ...
            ZLogger.d(String.format("GridPasswordView.onKey:%d-%s", keyCode, event.getCharacters()));
