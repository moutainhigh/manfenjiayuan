package com.mfh.framework.uikit.gridpasswordview.imebugfixer;
...
public class ImeDelBugFixedEditText extends EditText {
    ...
    private class ZanyInputConnection extends InputConnectionWrapper {
        ...
        public boolean sendKeyEvent(KeyEvent event) {
            ZLogger.d(String.format("ImeDelBugFixedEditText.GridPasswordView.sendKeyEvent:%d-%s",
                    event.getAction(), event.getCharacters()));
