...
import com.mfh.owner.bean.UserProfile;
import com.mfh.owner.ui.activity.NativeWebViewActivity;
import com.mfh.owner.ui.settings.SettingsActivity;
import com.mfh.owner.ui.settings.UserProfileActivity;
...
import com.mfh.owner.view.BadgeViewButton;
...
public class IndividualFragment extends BaseFragment{
    ...
    @Bind(R.id.button_pending_payment) BadgeViewButton btnPendingPayment;
...
//                    emptyView.setErrorType(EmptyLayout.HIDE_LAYOUT);
    ...
    private View.OnClickListener myOnClickListener = new View.OnClickListener(){
        ...
        public void onClick(View view) {
            switch(view.getId()){
                case R.id.iv_header:{
                    com.mfh.framework.uikit.UIHelper.startActivity(getActivity(), UserProfileActivity.class);
                }
                break;
...
//                    NativeWebViewActivity.actionStart(getActivity(), url, true, false, false);
                ...
                case R.id.item_2_2:{
                    ComnJBH5Activity.actionStart(getActivity(),
                            MobileURLConf.generateUrl(MobileURLConf.URL_ME_PARCEL, String.format("humanid=%d",
                                    MfhLoginService.get().getCurrentGuId())), true, false, -1);
                }
                break;
//                //跳转至任务
...
//                            true, IMConstants.ACTIVITY_REQUEST_SUBDIS_SELECT);
//                }
//                break;
//                case R.id.item_4_0:{
...
////                            true, IMConstants.ACTIVITY_REQUEST_RECEIVE_STOCK);
//                }
//                break;
            }
        }
