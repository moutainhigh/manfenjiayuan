...
//                                    }
                        DialogUtil.showHint(getString(R.string.toast_change_paypwd_succeess));
...
//                                }
        ...
        NetProxy.updatePayPassword(MfhLoginService.get().getCurrentGuId(), oldPwd, newPwd, responseCallback);
    }
}
