 ...
 */
public class CompanyListFragment extends BaseListFragment<CompanyInfo>
...
//    @Bind(R.id.animProgress)
    ...
    private CompanyInfoPresenter mInvCompanyPresenter;

    public static CompanyListFragment newInstance(Bundle args) {
...
//            onLoadFinished();
        ...
        mInvCompanyPresenter.findPublicCompanyInfo(mPageInfo, null, abilityItem);
