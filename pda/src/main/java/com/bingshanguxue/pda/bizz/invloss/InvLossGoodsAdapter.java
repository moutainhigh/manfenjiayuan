 ...
 */
public class InvLossGoodsAdapter extends SwipAdapter<InvLossGoodsEntity,
        InvLossGoodsAdapter.ProductViewHolder> {

    public InvLossGoodsAdapter(Context context, List<InvLossGoodsEntity> entityList) {
