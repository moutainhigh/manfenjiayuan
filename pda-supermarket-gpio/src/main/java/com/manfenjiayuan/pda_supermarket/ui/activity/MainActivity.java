...
import com.manfenjiayuan.pda_supermarket.scanner.IDataScanActivity;
 ...
 */
public class MainActivity extends IDataScanActivity implements IPosRegisterView{
...
//        finish();
    ...
    public void onEventMainThread(ValidateManager.ValidateManagerEvent event) {
        ...
        ZLogger.d(String.format("CashierServiceFragment: ValidateManagerEvent(%d)", eventId));
        switch (eventId) {
