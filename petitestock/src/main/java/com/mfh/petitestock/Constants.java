...
public class Constants {
    public static final int ARC_STOCKTAKE_LIST          = 0x01;
    public static final int ARC_OFFICE_LIST             = 0x02;//网点列表
    ...
    public static final int ARC_STOCKTAKE_SETTINGS      = 0x06;//库存盘点设置
