...
public class EditQueryView extends LinearLayout {
    ...
    public EditQueryView(Context context, AttributeSet attrs) {
        ...
        int rightImageButtonResId = ta.getResourceId(R.styleable.EditQueryView_editLabelView_rightImageButtonSrc, R.mipmap.ic_search_green);
...
//        });
        ...
        etInput.setOnKeyListener(new OnKeyListener() {
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                ZLogger.d(String.format("setOnKeyListener(%s.%s):%d", TAG, etInput.getClass().getSimpleName(), event.getKeyCode()));
                //Press “Enter”
