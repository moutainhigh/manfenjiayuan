 ...
 */
public class InvReturnOrderMode implements IInvReturnOrderMode<InvSendIoOrder> {
...
//        params.put("tenantId", String.valueOf(MfhLoginService.get().getSpid()));//收货网点所属租户
        ...
        AfinalFactory.postDefault(InvOrderApi.URL_INVSENDIOORDER_LIST, params, queryRsCallBack);
    }
}
