 ...
 */
public class SharedPreferencesUltimate extends SharedPrefesManagerBase {
    ...
    public static void setPosSkuLastUpdate(Date lastUpdate) {
        set(PK_SYNC_PRODUCTSKU_STARTCURSOR, TimeUtil.format(lastUpdate, TimeUtil.FORMAT_YYYYMMDDHHMMSS));
    }
    ...
    public static void setPosOrderLastUpdate(Date lastUpdate) {
        set(PK_S_POSORDER_SYNC_STARTCURSOR, TimeUtil.format(lastUpdate, TimeUtil.FORMAT_YYYYMMDDHHMMSS));
    }
...
//            e.printStackTrace();
    ...
    public static SharedPreferences getAppPreferences() {
        return getSharedPreferences(MfhApplication.getAppContext(), register());
    }

    public static SharedPreferences.Editor getAppEditor() {
        return getEditor(MfhApplication.getAppContext(), register());
    }
    ...
    public static String getText(String key, String defVal) {
        return getAppPreferences().getString(key, defVal);
    }

    public static int getInt(String key, int defVal) {
        return getAppPreferences().getInt(key, defVal);
    }

    public static Long getLong(String key, Long defVal) {
        return getAppPreferences().getLong(key, defVal);
    }
    public static boolean getBoolean(String key, boolean defVal) {
        return getAppPreferences().getBoolean(key, defVal);
    }
