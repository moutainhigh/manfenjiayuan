 ...
 */
public class PrepareTypeAdapter
        extends RegularAdapter<BizSubTypeWrapper, PrepareTypeAdapter.MenuOptioinViewHolder> {

    public PrepareTypeAdapter(Context context, List<BizSubTypeWrapper> entityList) {
    ...
    public MenuOptioinViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MenuOptioinViewHolder(mLayoutInflater
                .inflate(R.layout.itemview_prepareorder_type, parent, false));
    }

    @Override
    public void onBindViewHolder(final MenuOptioinViewHolder holder, final int position) {
        final BizSubTypeWrapper entity = entityList.get(position);
