 ...
 */
public class PurchaseStandardGoodsAdapter
        extends RegularAdapter<ScGoodsSku, PurchaseStandardGoodsAdapter.ProductViewHolder> {


    public PurchaseStandardGoodsAdapter(Context context, List<ScGoodsSku> entityList) {
