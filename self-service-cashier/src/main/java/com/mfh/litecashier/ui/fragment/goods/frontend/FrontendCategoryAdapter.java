 ...
 */
public class FrontendCategoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public FrontendCategoryAdapter(Context context, List<PosLocalCategoryEntity> entityList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == ITEM_TYPE.ITEM_TYPE_CATEGORY.ordinal()) {
            return new GoodsViewHolder(mLayoutInflater.inflate(R.layout.itemview_frontcategory, parent, false));
