 ...
 */
public class TenantCategoryListAdapter
        extends RegularAdapter<CategoryInfo, TenantCategoryListAdapter.ProductViewHolder> {


    public TenantCategoryListAdapter(Context context, List<CategoryInfo> entityList) {
    ...
    public void onBindViewHolder(final ProductViewHolder holder, final int position) {
        CategoryInfo entity = entityList.get(position);
...
//        }
        holder.tvProviderName.setText(entity.getNameCn());
        //TODO,动态添加标签
    }
