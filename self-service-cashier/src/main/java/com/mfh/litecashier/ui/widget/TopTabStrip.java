 ...
 * @author Peng fei Pan
 */
public class TopTabStrip extends HorizontalScrollView implements
	...
	public TopTabStrip(Context context, AttributeSet attrs) {
		super(context, attrs);
...
//						ViewGroup.LayoutParams.WRAP_CONTENT));
				...
				tabsLayout = (LinearLayout) LayoutInflater.from(getContext()).inflate(
						R.layout.horizontal_tabslayout, null, false);
				addView(tabsLayout, new ViewGroup.LayoutParams(
