...
public class WXUtil {
	...
	public static byte[] readFromFile(String fileName, int offset, int len) {
		...
		if(offset + len > (int) file.length()){
			ZLogger.e("readFromFile invalid file len:" + file.length());
			return null;
		}
		...
		try {
			...
			ZLogger.e("readFromFile : errMsg = " + e.getMessage());
			e.printStackTrace();
		}
		return b;
	}
	...
	public static Bitmap extractThumbNail(final String path, final int height, final int width, final boolean crop) {
		...
		try {
			...
			ZLogger.d("round=" + width + "x" + height + ", crop=" + crop);
			final double beY = options.outHeight * 1.0 / height;
			final double beX = options.outWidth * 1.0 / width;
			ZLogger.d("extract beX = " + beX + ", beY = " + beY);
	...
	public static String genSign(List<NameValuePair> params) {
		...
		String md5 = MD5Util.getMessageDigest(sb.toString().getBytes());
		String sign = (md5 != null ? md5.toUpperCase() : null);
		ZLogger.e("sign: " + sign);
		return sign;
	}
	/**
	...
	public static String genSian(String raw) {
		ZLogger.e("raw:" + raw);
		String md5 = MD5Util.getMessageDigest(raw.getBytes());
		String sign = (md5 != null ? md5.toUpperCase() : null);
		ZLogger.e("sign: " + sign);
		return sign;
	}
