package com.mfh.litecashier.components.order;
 ...
 */
public class GoodsOrderAdapter
        extends RegularAdapter<GoodsOrder, GoodsOrderAdapter.ProductViewHolder> {
    private GoodsOrder curPosOrder = null;

    public GoodsOrderAdapter(Context context, List<GoodsOrder> entityList) {
