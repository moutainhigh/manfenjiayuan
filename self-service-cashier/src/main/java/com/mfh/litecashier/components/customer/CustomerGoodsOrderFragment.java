 ...
 */
public class CustomerGoodsOrderFragment extends BaseListFragment<GoodsOrder>
    ...
    private CustomerGoodsOrderAdapter orderListAdapter;
    ...
    private void initOrderRecyclerView() {
        ...
        orderListAdapter = new CustomerGoodsOrderAdapter(CashierApp.getAppContext(), null);
        orderListAdapter.setOnAdapterListener(new CustomerGoodsOrderAdapter.OnAdapterListener() {
            @Override
            public void onItemClick(View view, int position) {
                GoodsOrderDialogFragment mdf = new GoodsOrderDialogFragment();
//                mdf.setOnCustomerQueryListener(querySettleCustomerListener);
                mdf.setPosOrder(orderListAdapter.getCurPosOrder());
                FragmentTransaction ft = getChildFragmentManager().beginTransaction();
                ft.setTransition(FragmentTransaction.TRANSIT_FRAGMENT_FADE).addToBackStack("customerGoodsOrderDetail");
                mdf.show(ft, "customerGoodsOrderDetail");
            }
...
//                ZLogger.d(String.format("%s %d(%d)", (dy > 0 ? "向上滚动" : "向下滚动"), lastVisibleItem, totalItemCount));
    ...
    public void onEventMainThread(CustomerEvent event) {
        ...
        if (eventId == CustomerEvent.EVENT_ID_CUSTOMER_GOODS_ORDERS_RELOAD) {
            reload();
        } else if (eventId == CustomerEvent.EVENT_ID_CUSTOMER_GOODS_ORDERS_PRINT) {
            print();
        }
    }
...
//            onLoadFinished();
        ...
        orderflowPresenter.findGoodsOrderList(mHumanId, mPageInfo);
...
//            throw new RuntimeException(ex);
    ...
    private void print() {
        PrinterFactory.getPrinterManager().printCustomerGoodsOrder(orderListAdapter.getEntityList());
    }
