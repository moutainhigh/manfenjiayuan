...
public class SharedPreferencesHelper {
    ...
    public static final String RELEASE_PREFIX = "release_pda_supermarket";
    public static final String DEV_PREFIX = "dev_pda_supermarket";
    public static String PREF_NAME_PREFIX = "pda_supermarket";
