...
import com.manfenjiayuan.pda_supermarket.ui.adapter.InvSendOrderAdapter;
...
//        EventBus.getDefault().register(this);
    ...
    protected void createViewInner(View rootView, ViewGroup container, Bundle savedInstanceState) {
        ...
        status = String.format("%d,%d", InvOrderApi.ORDER_STATUS_CONFIRM, InvOrderApi.ORDER_STATUS_SENDED);
        reload();
    }
