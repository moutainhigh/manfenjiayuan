...
import com.mfh.enjoycity.ui.life.DepthPageTransformer;
import com.mfh.enjoycity.view.HorizontalInnerViewPager;
...
//        Log.d("Nat,onPageSelected", String.format("onPageSelected: %d", arg0));
		if (isShowPoint) {
