...
public class HomeViewPageFragmentAdapter extends FragmentStatePagerAdapter {
    ...
    public HomeViewPageFragmentAdapter(FragmentManager fm,
    ...
    private void addFragment(ViewPageInfo info) {
        ...
        View v = LayoutInflater.from(mContext).inflate(
                R.layout.home_viewpage_fragment_tab_item, null, false);
