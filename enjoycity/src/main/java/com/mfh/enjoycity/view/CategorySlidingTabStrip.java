 ...
 * */
public class CategorySlidingTabStrip extends HorizontalScrollView implements
	...
	public CategorySlidingTabStrip(Context context) {
		this(context, null);
	}
...
//				tabsLayout = new LinearLayout(getContext());
				tabsLayout = (LinearLayout)LayoutInflater.from(getContext()).inflate(
						com.mfh.enjoycity.R.layout.category_tabslayout, null, false);
