...
public class ACacheHelper {
    ...
    public static final String CK_MYPROFILE = "ck_myProfile";
    public static final String CK_DEFAULT_NET = "ck_default_net";
    ...
    public static String getAsString(String key){
        return ACache.get(AppContext.getAppContext(), ACacheHelper.CACHE_NAME)
                .getAsString(key);
    }
