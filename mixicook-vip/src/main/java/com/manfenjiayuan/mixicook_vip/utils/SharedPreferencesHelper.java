...
public class SharedPreferencesHelper {
    ...
    //导入商品批发商数据
    public static final String PK_S_IMPORT_FROM_CHAINSKU_STARTCURSOR = "pk_import_from_startcursor";//时间戳
    ...
    public static final String PK_SYNC_FRONTEND_CATEGORYINFO_FRESH_ENABLED = "pk_sync_frontend_categoryinfo_fresh_enabled";//洗衣类目
    //后台商品类目
