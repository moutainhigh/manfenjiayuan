...
public class KDataSoapHelper {
     ...
     * */
    public static DataSoapSerializationEnvelope getSoapSerializationEnvelope(SoapObject request) {
        return getSoapSerializationEnvelope(SoapEnvelope.VER11, request);
    }

    public static DataSoapSerializationEnvelope getSoapSerializationEnvelope(int soapVersion, SoapObject request) {
        // SoapEnvelope.VER11: SOAP 1.1
        DataSoapSerializationEnvelope envelope = new DataSoapSerializationEnvelope(soapVersion);
    ...
    public static HttpTransportSE getHttpTransportSE(String url) {
        HttpTransportSE ht = new HttpTransportSE(Proxy.NO_PROXY, url, 100 * 1000);
     ...
     * 发送请求
     * */
    public static SoapObject call(DataSoapSerializationEnvelope envelope) {
