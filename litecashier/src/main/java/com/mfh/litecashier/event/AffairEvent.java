...
public class AffairEvent {
    ...
    //同步数据
    public static final int EVENT_ID_SYNC_DATA_INITIALIZE = 0X03;//恢复出厂设置
    public static final int EVENT_ID_SYNC_DATA_START = 0X04;//同步数据开始
    public static final int EVENT_ID_REDIRECT_TO_LOGIN = 0X07;//跳转至登录页面
    ...
    public static final int EVENT_ID_HIDE_LAUNDRY = 0X13;//洗衣服务
