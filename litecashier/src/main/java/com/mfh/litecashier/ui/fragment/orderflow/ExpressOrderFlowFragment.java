...
//        }
    ...
    public void onError(String errorMsg) {
        ...
        ZLogger.d("加载快递代揽订单流水失败:" + errorMsg);
        onLoadFinished();
    }
...
//                    ZLogger.d("缓存线下门店订单流水第一页数据");
                ...
                ACacheHelper.put(ACacheHelper.CK_ORDERFLOW_EXPRESS, cacheArrays.toJSONString());
            } else {
                if (entityList == null) {
                    entityList = new ArrayList<>();
                }
...
//            throw new RuntimeException(ex);
            ZLogger.e(String.format("加载快递代揽订单流水失败: %s", ex.toString()));
        }

        ZLogger.d(String.format("加载快递代揽订单流水, 请求%d/%d ,已加载(%d/%d)",
