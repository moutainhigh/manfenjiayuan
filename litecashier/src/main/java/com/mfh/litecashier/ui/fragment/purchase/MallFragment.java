...
//        mSwipeRefreshLayout = (SwipeRefreshLayout) rootView.findViewById(R.id.swiperefreshlayout);
    ...
    private void readTestData(){
        ...
        localList.add(CashierFunctional.generate(CashierFunctional.OPTION_ID_DEFECTIVE, "报损", R.mipmap.ic_commoditycenter_03));
        ...
        localList.add(CashierFunctional.generate(CashierFunctional.OPTION_ID_COURIER, "快递代收", R.mipmap.ic_commoditycenter_06));
