 ...
 */
public class PurchaseReceiptGoodsAdapter
        extends RegularAdapter<InvSendIoOrderItem, PurchaseReceiptGoodsAdapter.ProductViewHolder> {

    public PurchaseReceiptGoodsAdapter(Context context, List<InvSendIoOrderItem> entityList) {
    ...
    public ProductViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ProductViewHolder(mLayoutInflater.inflate(R.layout.itemview_purchase_receipt_goods, parent, false));
    }
