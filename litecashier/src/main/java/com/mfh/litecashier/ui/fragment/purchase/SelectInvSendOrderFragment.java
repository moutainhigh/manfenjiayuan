 ...
 */
public class SelectInvSendOrderFragment extends BaseListFragment<InvSendOrder> implements IInvSendOrderView {
    ...
    public static SelectInvSendOrderFragment newInstance(Bundle args) {
        SelectInvSendOrderFragment fragment = new SelectInvSendOrderFragment();
...
//                ZLogger.d(String.format("%s %d(%d)", (dy > 0 ? "向上滚动" : "向下滚动"), lastVisibleItem, totalItemCount));
        ...
        productAdapter = new SelectSendOrderAdapter(getActivity(), null);
        productAdapter.setOnAdapterListener(new SelectSendOrderAdapter.OnAdapterListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                EventBus.getDefault().post(new PurchaseReceiptCreateEvent(PurchaseReceiptCreateEvent.EVENT_ID_RELOAD_INV_SENDORDER, args));
...
//        }
        ...
        invSendOrderPresenter.loadOrders(mPageInfo, true,
                MfhLoginService.get().getCurOfficeId(), sendTenantId, status);
