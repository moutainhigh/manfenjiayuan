 ...
 */
public class InvIOGoodsAdapter
        extends RegularAdapter<InvIoOrderItem, InvIOGoodsAdapter.ProductViewHolder> {

    public InvIOGoodsAdapter(Context context, List<InvIoOrderItem> entityList) {
    ...
    public ProductViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ProductViewHolder(mLayoutInflater.inflate(R.layout.itemview_stockbatch_goods, parent, false));
    }

    @Override
    public void onBindViewHolder(final ProductViewHolder holder, final int position) {
        InvIoOrderItem entity = entityList.get(position);
...
//        holder.tvPriceType.setText(entity.getPriceType() == 0 ? "计件" : "计重");
        holder.tvOrderType.setText(entity.getOrderTypeCaption());
    }
...
//            });
    ...
    @Override
    public void setEntityList(List<InvIoOrderItem> entityList) {
