...
public class AccountDialog extends CommonDialog {
    ...
    private Button btnLock, btnHandOver, btnDailySettle, btnLogout;
...
//        ButterKnife.bind(rootView);
        ...
        btnDailySettle = (Button) rootView.findViewById(R.id.button_dailysettle);
        ...
        btnDailySettle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mListener != null) {
                    mListener.onDailySettle();
                }
                dismiss();
            }
        });
...
//        this.dialogType = type;
        ...
        if (type == 0){
            ...
            btnDailySettle.setVisibility(View.GONE);
            btnLogout.setText("登录");
        }else{
            btnLock.setVisibility(View.VISIBLE);
            btnHandOver.setVisibility(View.VISIBLE);
            btnDailySettle.setVisibility(View.VISIBLE);
