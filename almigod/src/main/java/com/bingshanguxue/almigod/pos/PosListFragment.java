...
public class PosListFragment extends BaseListFragment<CompanyInfo>
    ...
    public static PosListFragment newInstance(Bundle args) {
        PosListFragment fragment = new PosListFragment();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mInvCompanyPresenter = new PosRegisterPresenter(this);
    }
...
//                ZLogger.d(String.format("%s %d(%d)", (dy > 0 ? "向上滚动" : "向下滚动"), lastVisibleItem, totalItemCount));
        ...
        companyAdapter = new PosRegisterAdapter(getActivity(), null);
        companyAdapter.setOnAdapterListener(new PosRegisterAdapter.OnAdapterListener() {
            @Override
            public void onItemClick(View view, int position) {
                //TODO,跳转至详情页
                Intent data = new Intent();
                data.putExtra("posRegister", companyAdapter.getEntity(position));
...
//            onLoadFinished();
    ...
    @Override
    public void onIPosRegisterViewProcess() {

        onLoadStart();
    }

    @Override
    public void onIPosRegisterViewError(String errorMsg) {

        onLoadFinished();
    }

    @Override
    public void onIPosRegisterViewSuccess(PageInfo pageInfo, List<PosRegister> dataList) {
        try {
            mPageInfo = pageInfo;
